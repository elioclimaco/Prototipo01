<template>
    <aside :class="['main-sidebar', 'col-12', 'col-md-3', 'col-lg-2', 'px-0', sidebarVisible ? 'open' : '']">
        ...
        <div class="main-navbar">
            ...
            <nav class="navbar align-items-stretch navbar-light bg-PJ_Fondo flex-md-nowrap border-bottom p-0">
...
// Color de los ítems del SideBar
// $fiord-blue:   #3D5170 !default;

// eclimacoh: Personalización de la SideBar.
.main-sidebar {
  top: 0;
}
...
https://github.com/javierbrk/reconocedordebilletes/wiki/Tutorial-Fork-y-Sincronizacion
*/
</style>
